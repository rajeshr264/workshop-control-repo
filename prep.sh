...
curl "https://raw.githubusercontent.com/rajeshr264/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:rajeshr264/workshop-control-repo
